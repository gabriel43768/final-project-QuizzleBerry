...
<head>
    ...
    <title>Quizzleberry - Smart Study Tools for Better Learning</title>
    <style>
        :root {
            --primary: #4b2c91;
    ...
    <header>
        <div class="container">
            <div class="nav-container">
                <div class="logo">
                    <img src="111.png" alt="Quizzleberry Logo">
                    <div class="logo-text">Quizzleberry</div>
                </div>
...
<section class="features" id="features">
    <div class="container">
        ...
        <p class="section-subtitle">Quizzleberry uses proven learning methods to help you master any subject.</p>
        ...
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p class="feature-description">
                  Use the flashcards already available on the platform or create your own sets to focus on key concepts and tailor your study according to your pace and goals.
                </p>
            </div>
        ...
        <div class="footer-grid">
            <div>
                <div class="footer-logo">
                    <img src="111.png" alt="Quizzleberry Logo">
                    <div class="footer-logo-text">Quizzleberry</div>
                </div>
            ...
            <div>
                ...
                <ul class="footer-links">
                    <li><a href="mailto:info@quizzleberry.com">info@quizzleberry.com</a></li>
                </ul>
            </div>
        </div>

        <div class="footer-bottom">
            <p>&copy; 2025 Quizzleberry. All rights reserved.</p>
        </div>
    </div>
</footer>
